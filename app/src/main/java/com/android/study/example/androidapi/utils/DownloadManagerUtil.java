...
//    }
     ...
     * @param desc  文件路径
     */
    public static long download(Activity activity, String url, String title, String desc) {
...
//        request.setDescription(desc);
        ...
        request.setDestinationUri(Uri.fromFile(new File(activity.getExternalFilesDir("files")+"lvjie.apk")));
     ...
     * @param downloadId
     */
    public void clearCurrentTask(Activity activity, long downloadId) {
