...
import com.android.study.example.filepicker.filter.entity.AudioFile;
...
public class AudioPickAdapter extends BaseAdapter<AudioFile, AudioPickAdapter.AudioPickViewHolder> {
    ...
    public AudioPickViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(mContext).inflate(R.layout.layout_file_picker_item_audio_pick, parent, false);
